...
public class LiveVideoBroadcasterActivity extends AppCompatActivity {
    ...
    TextView nowPriceTV;
    String rtmpUrl = "rtmp://ec2-13-209-50-167.ap-northeast-2.compute.amazonaws.com/live/";
    String liveId;
    //네티서버용 변수
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        liveId = gIntent.getStringExtra("liveId");

        mTimerHandler = new TimerHandler();
        mStreamNameEditText = findViewById(R.id.stream_name_text_view);
        ...
        //수정
        nowPriceTV = findViewById(R.id.nowPriceTV);
        nowPriceTV.setText(gIntent.getStringExtra("nowPrice"));
        ...
        mStreamNameEditText.setText(gIntent.getStringExtra("liveName"));
        mBroadcastControlButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if(mBroadcastControlButton.getText().toString().equals("Start Broadcasting")){
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if(checkUpdate.getState() == checkUpdate.getState().NEW){
                                checkUpdate.start();
                                new SendPriceTask().execute("liveRoom//"+liveId+"//"+nowPriceTV.getText().toString());
                            }
                        }
                    }).start();
                    ...
                    //시작 메소드
                    //startBroadcating param -> serverRtmpUrl+getIntent.liveId
                    mLiveVideoBroadcaster
                    .startBroadcasting(rtmpUrl+liveId);
                    mBroadcastControlButton.setText(R.string.stop_broadcasting);
                    new SendPriceTask().execute("liveStart//"+liveId);
                }else{
                    //종료 메소드
                    mLiveVideoBroadcaster.stopBroadcasting();
                    new SendPriceTask().execute("liveEnd//"+liveId+"//"+new SessionManager(getApplicationContext()).getUserId());
                    //버튼 사라지고 결제 대기 페이지로
    ...
    private Runnable showUpdate = new Runnable() {
        ...
        public void run() {
            ...
            if(type.equals("liveEnd")){
                /*if(receive.split("//")[1].equals(new SessionManager(getApplicationContext()).getUserId())){
