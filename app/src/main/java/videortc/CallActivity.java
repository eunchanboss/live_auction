...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //rtc.no3 - 생성된 방값을 전화면에서 가져와서 만든다.
        ...
        roomIdTextView.setText(getString(R.string.room_id_caption) + gIntent.getStringExtra("randomRoomId"));
        Log.d(TAG, getString(R.string.room_id_caption) + gIntent.getStringExtra("randomRoomId"));

        // Connect video call to the random room
        connectVideoCall(gIntent.getStringExtra("randomRoomId"));
    }
    ...
    private void disconnect() {
        ...
        Intent gIntent = getIntent();
        //rtc.no5
        Intent intent = new Intent(CallActivity.this,ChatInList.class);
